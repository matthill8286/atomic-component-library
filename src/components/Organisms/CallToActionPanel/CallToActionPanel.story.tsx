...
export default {
  title: 'Design System/Organisms/CallToActionPanel',
}
  ...
  return (
    <SimpleCallToAction {...defaultKnobs()} image={image}>
      <CopyText>
        ...
        multi-professional organisation whose aim is to promote the health of children with special
        attention to the gastrointestinal tract, liver and nutritional status, through knowledge
        creation, the dissemination of science based information, the promotion of best practice in
        the delivery of care and the provision of high quality education for paediatric
        gastroenterology, hepatology and nutrition professionals in Europe and beyond.
      </CopyText>
    </SimpleCallToAction>
  )
}
...
_2AlternateRows.story = {
  name: '2 alternate rows',
}

export const PassingElement = () => {
  return (
    <>
      <CallToActionPanel
        {...defaultKnobs()}
...
PassingElement.story = {
  name: 'passing element',
}
