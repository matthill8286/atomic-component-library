...
import { StyledButton, StyledDistanceBadge, StyledMarketInfo, StyledMarketInfoHeaderRow } from './MarketInfo.styled'
...
describe('<Marketinfo />', () => {
  ...
  describe('<Button>:', () => {
    test('Calls saveSelectedMarket()', () => {
      ...
      const component = mountWithTheme(<MarketInfo {...props} saveSelectedMarket={mockSaveSelectedMarket} />)
    ...
    test('Should not call saveSelectedMarket() when availabity is NOT_AVAILABLE', () => {
      ...
      const component = mountWithTheme(<MarketInfo {...newProps} saveSelectedMarket={mockSaveSelectedMarket} />)
