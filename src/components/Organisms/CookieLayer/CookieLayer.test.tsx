...
describe('Button', () => {
  ...
  it('Should render cookie layer wrapper', () => {
    const tree = renderWithTheme(<CookieLayer button={button} headline={headline} infoText={copyText} />)
    expect(tree).toMatchSnapshot()
  })

  it('Should be clickable', () => {
    const tree = mountWithTheme(
      <CookieLayer button={button} headline={headline} infoText={copyText} onCookieLayerAgree={onClick} />,
    )
