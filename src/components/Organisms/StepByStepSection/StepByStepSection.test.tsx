...
const copyText = 'In the story, a donkey, a dog, a cat, and a rooster leave their homes and set out together.'
...
describe('StepByStepSection', () => {
  ...
  describe('StepByStepSection:Steps', () => {
    ...
    const flexbox = component.find('FlexBox').find('div').first()
    ...
    it('renders icon index and color correctly', () => {
      const secondStepIconProps = steps.find('IndexIcon').at(1).props()
    ...
    it('renders text correctly', () => {
      const firstStepText = steps.find('CopyText').first().find('p').text()
