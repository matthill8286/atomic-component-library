                    ...
                    {productElement.product && (
                      <ProductCell linkUrl={linkUrl}>
                        ...
                        <CopyText tag={'span'} fontSize={'sm'}>
                          {convertPrice(productElement?.price?.price, productElement?.price?.currency, '', false)}
                        </CopyText>
                      </ProductCell>
                    )}
                  </TableCell>
              ...
              row.tableRow && (
                <TableRow key={'feature-' + rowIndex}>
                  {row.tableRow.map((featureCell: TableRowDataProps, index) => {
                    return (
                      <TableCell key={index + featureCell.text} cellType={featureCell.isFeatureName ? 'th' : 'td'}>
