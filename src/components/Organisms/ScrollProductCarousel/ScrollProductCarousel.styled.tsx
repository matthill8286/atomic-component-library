...
export const TileWrapper = styled.article<StyledTileWrapperProps>`
  ...
  padding-top: ${({ theme, withLabels }) => (withLabels ? theme.spacing.base.sm : theme.spacing.base.xs)};
  width: 100%;
...
export const CarouselWrapper = styled.div<CarouselWrapperProps & { isGridLayout?: boolean; setFixedWidth?: boolean }>`
