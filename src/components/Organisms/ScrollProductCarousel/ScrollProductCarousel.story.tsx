...
PlaylistCollection.story = {
  name: 'Playlist collection',
}

export const PlaylistsWithDisabledIndexes = () => {
  return (
    <Grid>
      <Row>
        <Cell columns={12}>
...
PlaylistsWithDisabledIndexes.story = {
  name: 'Playlists with disabled indexes',
}

export const PlaylistsFixedWidthProductOnDesktop = () => {
  return (
    <Grid>
      <Row>
        <Cell columns={12}>
...
PlaylistsFixedWidthProductOnDesktop.story = {
  name: 'Playlists fixed width product on desktop',
}

export const PlaylistsViewLandscape = () => {
  return (
    <Grid>
      <Row>
        <Cell columns={12}>
      ...
      <Row>
        <Cell columns={12}>
          <CopyText display="flex" fontSize="lg">
            Due to the amount of information on this version of product tile, the best viewing mode
...
PlaylistsViewLandscape.story = {
  name: 'Playlists view landscape',
}
