...
export const ServicesWrapper = styled.div<{ variant: ServicesVariant }>`
  ...
  background: ${({ variant, theme }) => (variant === 'light' ? theme.color.white : theme.color.black)} no-repeat center
    center;
  ...
  &:hover {
    ...
    .the-overline {
      background: ${({ variant, theme }) => (variant === 'light' ? theme.color.black : theme.color.alert)};
    }
  }
`
