...
export const _CounterWithTimer = () => {
  ...
  return (
    <div style={{ background: props.backgroundColor }}>
      <CounterWithTimer toUTC={setToUTCToUndefined ? undefined : new Date(toDate).toUTCString()} {...props} />
    </div>
  )
}

export const CounterHidesDaysAndShowsSeconds = () => {
...
CounterHidesDaysAndShowsSeconds.story = {
  name: 'Counter Hides Days and Shows Seconds',
}
